  ...
  return (
    <footer className="relative z-10 border-t border-brand-border bg-brand-bg/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <span className="font-display font-bold text-brand-text text-lg">Scholar<span className="text-brand-accent">Match</span></span>
          <p className="text-brand-muted text-sm mt-1">Built for the Hack Canada 2026</p>
